import{_ as ht,r as ye,c as J,o as Y,a as D,s as dt,F as we,k as ft}from"./index-DluYrt7x.js";const pt=()=>{};var Ee={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function de(t){return t.endsWith(".cloudworkstations.dev")}async function Rt(t){return(await fetch(t,{credentials:"include"})).ok}/**
 * @license
...
</defs>`,_.innerText="Preview backend running in this workspace."),_.setAttribute("id",p)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",d):d()}function kt(){try{return typeof indexedDB=="object"}catch{return!1}}function Bt(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var i;e(((i=s.error)===null||i===void 0?void 0:i.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nt="FirebaseError";class P extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Nt,Object.setPrototypeOf(this,P.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Fe.prototype.create)}}class Fe{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?Ut(i,r):"Error",c=`${this.serviceName}: ${o} (${s}).`;return new P(s,c,r)}}function Ut(t,e){return t.replace(xt,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const xt=/\{\$([^}]+)}/g;function ie(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],o=e[s];if(ve(i)&&ve(o)){if(!ie(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function ve(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(rn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function rn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ce="@firebase/app",Te="0.13.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T=new zt("@firebase/app"),sn="@firebase/app-compat",on="@firebase/analytics-compat",an="@firebase/analytics",cn="@firebase/app-check-compat",ln="@firebase/app-check",un="@firebase/auth",hn="@firebase/auth-compat",dn="@firebase/database",fn="@firebase/data-connect",pn="@firebase/database-compat",mn="@firebase/functions",gn="@firebase/functions-compat",_n="@firebase/installations",bn="@firebase/installations-compat",yn="@firebase/messaging",wn="@firebase/messaging-compat",En="@firebase/performance",Cn="@firebase/performance-compat",vn="@firebase/remote-config",In="@firebase/remote-config-compat",An="@firebase/storage",Rn="@firebase/storage-compat",Tn="@firebase/firestore",Dn="@firebase/ai",Sn="@firebase/firestore-compat",On="firebase",kn="11.9.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mn=kn;function ze(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:le,automaticDataCollectionEnabled:!0},e),s=r.name;if(typeof s!="string"||!s)throw k.create("bad-app-name",{appName:String(s)});if(n||(n=He()),!n)throw k.create("no-options");const i=G.get(s);if(i){if(ie(n,i.options)&&ie(r,i.config))return i;throw k.create("duplicate-app",{appName:s})}const o=new $t(s);for(const a of ue.values())o.addComponent(a);const c=new Ln(n,r,o);return G.set(s,c),c}function $n(t=le){const e=G.get(t);if(!e&&t===le&&He())return ze();if(!e)throw k.create("no-app",{appName:t});return e}function x(t,e,n){var r;let s=(r=Bn[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),T.warn(c.join(" "));return}q(new H(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zn(t){q(new H("platform-logger",e=>new nn(e),"PRIVATE")),q(new H("heartbeat",e=>new Wn(e),"PRIVATE")),x(ce,Te,t),x(ce,Te,"esm2017"),x("fire-js","")}Zn("");var Xn="firebase",Jn="11.9.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(t,e,n){let r=1,s=null,i=null,o=!1,c=0;function a(){return c===2}let u=!1;function h(...b){u||(u=!0,e.apply(null,b))}function d(b){s=setTimeout(()=>{s=null,t(p,a())},b)}function l(){i&&clearTimeout(i)}function p(b,...R){if(u){l();return}if(b){l(),h.call(null,b,...R);return}if(a()||o){l(),h.call(null,b,...R);return}r<64&&(r*=2);let E;c===1?(c=2,E=0):E=(r+Math.random())*1e3,d(E)}let _=!1;function I(b){_||(_=!0,l(),!u&&(s!==null?(b||(c=2),clearTimeout(s),d(0)):b||(c=1)))}return d(0),i=setTimeout(()=>{o=!0,I(!0)},n),I}function gr(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wr{constructor(e,n,r,s,i,o,c,a,u,h,d,l=!0,p=!1){this.url_=e,this.method_=n,this.headers_=r,this.body_=s,this.successCodes_=i,this.additionalRetryCodes_=o,this.callback_=c,this.errorCallback_=a,this.timeout_=u,this.progressCallback_=h,this.connectionFactory_=d,this.retry=l,this.isUsingEmulator=p,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((_,I)=>{this.resolve_=_,this.reject_=I,this.start_()})}start_(){const e=(r,s)=>{if(s){r(!1,new j(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const o=c=>{const a=c.loaded,u=c.lengthComputable?c.total:-1;this.progressCallback_!==null&&this.progressCallback_(a,u)};this.progressCallback_!==null&&i.addUploadProgressListener(o),i.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(o),this.pendingConnection_=null;const c=i.getErrorCode()===N.NO_ERROR,a=i.getStatus();if(!c||yr(a,this.additionalRetryCodes_)&&this.retry){const h=i.getErrorCode()===N.ABORT;r(!1,new j(!1,null,h));return}const u=this.successCodes_.indexOf(a)!==-1;r(!0,new j(u,i))})},n=(r,s)=>{const i=this.resolve_,o=this.reject_,c=s.connection;if(s.wasSuccessCode)try{const a=this.callback_(c,c.getResponse());_r(a)?i(a):i()}catch(a){o(a)}else if(c!==null){const a=pe();a.serverResponse=c.getErrorText(),this.errorCallback_?o(this.errorCallback_(c,a)):o(a)}else if(s.canceled){const a=this.appDelete_?Ze():or();o(a)}else{const a=ir();o(a)}};this.canceled_?n(!1,new j(!1,null,!0)):this.backoffId_=mr(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&gr(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class j{constructor(e,n,r){this.wasSuccessCode=e,this.connection=n,this.canceled=!!r}}function Er(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function Cr(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function vr(t,e){e&&(t["X-Firebase-GMPID"]=e)}function Ir(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function Ar(t,e,n,r,s,i,o=!0,c=!1){const a=Xe(t.urlParams),u=t.url+a,h=Object.assign({},t.headers);return vr(h,e),Er(h,n),Cr(h,i),Ir(h,r),new wr(u,t.method,h,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,s,o,c)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rr(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function Tr(...t){const e=Rr();if(e!==void 0){const n=new e;for(let r=0;r<t.length;r++)n.append(t[r]);return n.getBlob()}else{if(ge())return new Blob(t);throw new g(m.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function Dr(t,e,n){return t.webkitSlice?t.webkitSlice(e,n):t.mozSlice?t.mozSlice(e,n):t.slice?t.slice(e,n):null}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lr(t,e){return e}class w{constructor(e,n,r,s){this.server=e,this.local=n||e,this.writable=!!r,this.xform=s||Lr}}let z=null;function Mr(t){return!me(t)||t.length<2?t:tt(t)}function nt(){if(z)return z;const t=[];t.push(new w("bucket")),t.push(new w("generation")),t.push(new w("metageneration")),t.push(new w("name","fullPath",!0));function e(i,o){return Mr(o)}const n=new w("name");n.xform=e,t.push(n);function r(i,o){return o!==void 0?Number(o):o}const s=new w("size");return s.xform=r,t.push(s),t.push(new w("timeCreated")),t.push(new w("updated")),t.push(new w("md5Hash",null,!0)),t.push(new w("cacheControl",null,!0)),t.push(new w("contentDisposition",null,!0)),t.push(new w("contentEncoding",null,!0)),t.push(new w("contentLanguage",null,!0)),t.push(new w("contentType",null,!0)),t.push(new w("metadata","customMetadata",!0)),z=t,z}function $r(t,e){function n(){const r=t.bucket,s=t.fullPath,i=new C(r,s);return e._makeStorageReference(i)}Object.defineProperty(t,"ref",{get:n})}function Hr(t,e,n){const r={};r.type="file";const s=n.length;for(let i=0;i<s;i++){const o=n[i];r[o.local]=o.xform(r,e[o.server])}return $r(r,t),r}function rt(t,e,n){const r=et(e);return r===null?null:Hr(t,r,n)}function Fr(t,e,n,r){const s=et(e);if(s===null||!me(s.downloadTokens))return null;const i=s.downloadTokens;if(i.length===0)return null;const o=encodeURIComponent;return i.split(",").map(u=>{const h=t.bucket,d=t.fullPath,l="/b/"+o(h)+"/o/"+o(d),p=_e(l,n,r),_=Xe({alt:"media",token:u});return p+_})[0]}function Vr(t,e){const n={},r=e.length;for(let s=0;s<r;s++){const i=e[s];i.writable&&(n[i.server]=t[i.local])}return JSON.stringify(n)}class st{constructor(e,n,r,s){this.url=e,this.method=n,this.handler=r,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function it(t){if(!t)throw pe()}function jr(t,e){function n(r,s){const i=rt(t,s,e);return it(i!==null),i}return n}function zr(t,e){function n(r,s){const i=rt(t,s,e);return it(i!==null),Fr(i,s,t.host,t._protocol)}return n}function ot(t){function e(n,r){let s;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?s=rr():s=nr():n.getStatus()===402?s=tr(t.bucket):n.getStatus()===403?s=sr(t.path):s=r,s.status=n.getStatus(),s.serverResponse=r.serverResponse,s}return e}function Wr(t){const e=ot(t);function n(r,s){let i=e(r,s);return r.getStatus()===404&&(i=er(t.path)),i.serverResponse=s.serverResponse,i}return n}function Gr(t,e,n){const r=e.fullServerUrl(),s=_e(r,t.host,t._protocol),i="GET",o=t.maxOperationRetryTime,c=new st(s,i,zr(t,n),o);return c.errorHandler=Wr(e),c}function qr(t,e){return t&&t.contentType||e&&e.type()||"application/octet-stream"}function Kr(t,e,n){const r=Object.assign({},n);return r.fullPath=t.path,r.size=e.size(),r.contentType||(r.contentType=qr(null,e)),r}function Zr(t,e,n,r,s){const i=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function c(){let E="";for(let y=0;y<2;y++)E=E+Math.random().toString().slice(2);return E}const a=c();o["Content-Type"]="multipart/related; boundary="+a;const u=Kr(e,r,s),h=Vr(u,n),d="--"+a+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lt="storage";function is(t,e,n){return t=K(t),Yr(t,e,n)}function os(t){return t=K(t),Qr(t)}function as(t,e){return t=K(t),rs(t,e)}function cs(t=$n(),e){t=K(t);const r=Un(t,lt).getImmediate({identifier:e}),s=It("storage");return s&&ls(r,...s),r}function ls(t,e,n,r={}){ss(t,e,n,r)}function us(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new be(n,r,s,e,Mn)}function hs(){q(new H(lt,us,"PUBLIC").setMultipleInstances(!0)),x(xe,Pe,""),x(xe,Pe,"esm2017")}hs();const ds={apiKey:void 0,authDomain:void 0,databaseURL:void 0,projectId:void 0,storageBucket:void 0,messagingSenderId:void 0,appId:void 0,measurementId:void 0},fs=ze(ds),ps=cs(fs),ms={class:"custum-file-upload",for:"file"},gs={class:"row mt-4 g-4"},_s={style:{border:"0px"},class:"card position-relative overflow-hidden rounded-4"},bs=["onClick"],ys=["src"],ws={__name:"ImageUpload",emits:["update-avatar"],setup(t,{emit:e}){const n=ye([]),r=ye([]),s=e,i=a=>{const u=r.value.splice(a,1);u.length&&u[0].url&&URL.revokeObjectURL(u[0].url)};function o(a){const u=Array.from(a.target.files);r.value.forEach(h=>URL.revokeObjectURL(h)),r.value=u.filter(h=>h.type.startsWith("image/")).map(h=>({file:h,url:URL.createObjectURL(h)}))}async function c(){if(r.value.length){for(const{file:a}of r.value){const u=`images/${Date.now()}_${a.name}`,h=as(ps,u);try{await is(h,a);const d=await os(h);n.value.push(d),console.log("Uploaded:",d)}catch(d){console.error("Upload error:",d)}}s("update-avatar",n.value)}}return(a,u)=>(Y(),J(we,null,[D("label",ms,[u[0]||(u[0]=dt('<div class="icon" data-v-028399ff><svg xmlns="http://www.w3.org/2000/svg" fill="" viewBox="0 0 24 24" data-v-028399ff><g stroke-width="0" id="SVGRepo_bgCarrier" data-v-028399ff></g><g stroke-linejoin="round" stroke-linecap="round" id="SVGRepo_tracerCarrier" data-v-028399ff></g><g id="SVGRepo_iconCarrier" data-v-028399ff><path fill="" d="M10 1C9.73478 1 9.48043 1.10536 9.29289 1.29289L3.29289 7.29289C3.10536 7.48043 3 7.73478 3 8V20C3 21.6569 4.34315 23 6 23H7C7.55228 23 8 22.5523 8 22C8 21.4477 7.55228 21 7 21H6C5.44772 21 5 20.5523 5 20V9H10C10.5523 9 11 8.55228 11 8V3H18C18.5523 3 19 3.44772 19 4V9C19 9.55228 19.4477 10 20 10C20.5523 10 21 9.55228 21 9V4C21 2.34315 19.6569 1 18 1H10ZM9 7H6.41421L9 4.41421V7ZM14 15.5C14 14.1193 15.1193 13 16.5 13C17.8807 13 19 14.1193 19 15.5V16V17H20C21.1046 17 22 17.8954 22 19C22 20.1046 21.1046 21 20 21H13C11.8954 21 11 20.1046 11 19C11 17.8954 11.8954 17 13 17H14V16V15.5ZM16.5 11C14.142 11 12.2076 12.8136 12.0156 15.122C10.2825 15.5606 9 17.1305 9 19C9 21.2091 10.7909 23 13 23H20C22.2091 23 24 21.2091 24 19C24 17.1305 22.7175 15.5606 20.9844 15.122C20.7924 12.8136 18.858 11 16.5 11Z" clip-rule="evenodd" fill-rule="evenodd" data-v-028399ff></path></g></svg></div><div class="text" data-v-028399ff><span data-v-028399ff>Click to upload image</span></div>',2)),D("input",{type:"file",id:"file",multiple:"",onChange:o},null,32)]),D("div",gs,[u[1]||(u[1]=D("h3",null,"Ảnh đã tải lên :",-1)),(Y(!0),J(we,null,ft(r.value,(h,d)=>(Y(),J("div",{class:"col-3",key:d},[D("div",_s,[D("button",{class:"close-image",onClick:l=>i(d)},"x",8,bs),D("img",{class:"card-img rounded-4 custom-shadow",style:{height:"450px","object-fit":"cover"},src:h.url,alt:"Card image"},null,8,ys)])]))),128)),D("button",{onClick:c},"Tải ảnh lên")])],64))}},Cs=ht(ws,[["__scopeId","data-v-028399ff"]]);export{Cs as default};
