...
export default [
    ...
    {
        path: 'BankCodes',
        component: import('../../components/Admin/BankCodes/index.vue'),
        props: route => ({ TableName: 'BankCodes' })
    },
    {
        path: 'BankCodes/create',
        component: () => import('../../components/Admin/BankCodes/Form.vue'),
        props: route => ({ TableName: 'BankCodes', action: 'create' })
    },
    {
        path: 'BankCodes/view/:id',
        component: () => import('../../components/Admin/BankCodes/Form.vue'),
        props: route => ({ TableName: 'BankCodes', action: 'view', id: route.params.id, })
    },
    {
        path: 'BankCodes/update/:id',
        component: () => import('../../components/Admin/BankCodes/Form.vue'),
