...
const openModal = (product) => {
  ...
  for (const groupName in mapVarriantsOfListBaseProduct.value) {
...
const closeModal = () => {
  ...
  mapVarriantsOfListBaseProduct.value = mapVarriants.value
  for (const groupName in mapVarriantsOfListBaseProduct.value) {
    selectedVariant.value[groupName] = [];
  }
...
const fetchProductData = async (id) => {
  try {
    ...
    console.log("SkuColorList:", SkuColorList.value);
    console.log("SkuSizeList:", SkuSizeList.value);
