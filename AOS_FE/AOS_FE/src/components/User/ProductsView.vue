...
<div class="accordion accordion-flush" id="accordionFlushExample">
  ...
  <ul class="filter-list">
    <li>
      <label><input type="checkbox" name="price" value="100-200" /> 100k - 200k</label>
    </li>
    <li>
      <label><input type="checkbox" name="price" value="200-500" /> 200k - 500k</label>
    </li>
    <li>
      <label><input type="checkbox" name="price" value="500-700" /> 500k - 700k</label>
    </li>
    <li>
