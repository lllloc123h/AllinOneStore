  ...
  <main>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../../assets/imgs/slider_1 - Copy.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../../assets/imgs/slider_2 - Copy.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../../assets/imgs/slider_3 - Copy.png" class="d-block w-100" alt="...">
        </div>
      </div>
    ...
    <div style="" class="container-fluid px-5">
      ...
      <div class="hstack mt-5 align-items-center">
        <div>
          <h3>San pham giam gia</h3>
        </div>
        <div class="ms-auto">
          <p class="mb-0"><!-- From Uiverse.io by alexmaracinaru -->
            <button id="next">
              <span>Xem thêm</span>
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-end">
                ...
                <div class="main-section rounded-4">
                  ...
                  <button class="second-button"> <svg viewBox="0 0 24 24" width="20" height="20" stroke="#ffd300"
                      stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                      <circle cx="9" cy="21" r="1"></circle>
                      <circle cx="20" cy="21" r="1"></circle>
                      <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
                    </svg> 3,4k đã bán</button>
                </div>
    ...
    <!--start gioi thieu -->
    <section style="background-color: #f1cdbd; padding: 8rem 2rem;margin-top: 100px;margin-bottom: 100px;">
  <div class="container">
    <div class="row align-items-center">
      <!-- Bên trái -->
      <div class="col-md-6 mb-4 mb-md-0">
        <h2 class="fw-bold text-white mb-4">Hãy xem qua những điểm bán hàng độc đáo của chúng tôi</h2>
         <p class="mb-0"><!-- From Uiverse.io by alexmaracinaru -->
            <button id="next">
              <span>Xem thêm</span>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 74 74" height="34" width="34">
...
<!--end gioi thieu -->
  ...
  <div class="container">
    <div class="row align-items-center">
      <!-- Bên trái -->
      <div class="col-md-6 mb-4 mb-md-0">
        <h2 class="fw-bold text-black mb-4">Hãy xem qua những điểm bán hàng độc đáo của chúng tôi</h2>
         <p class="mb-0"><!-- From Uiverse.io by alexmaracinaru -->
            <button id="next">
              <span>Xem thêm</span>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 74 74" height="34" width="34">
