    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          ...
          <input :id="image" v-model="formData.image" type="text" class="form-control" :placeholder="`Enter image`" />
        </div>

        <div class="mb-3">
          <label :for="isHome" class="form-label text-capitalize">isHome</label>
          <input :id="isHome" v-model="formData.isHome" type="text" class="form-control"
