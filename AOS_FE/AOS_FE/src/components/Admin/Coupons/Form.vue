    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          ...
          <input :id="code" v-model="formData.code" type="text" class="form-control" :placeholder="`Enter code`" />
        </div>
        ...
        <div class="mb-3">
          ...
          <input :id="maxDiscountAmount" v-model="formData.maxDiscountAmount" type="number" class="form-control"
        ...
        <div class="mb-3">
          ...
          <input :id="isAllowVoucher" v-model="formData.isAllowVoucher" type="text" class="form-control"
        ...
        <div class="mb-3">
          ...
          <input :id="customerGroup" v-model="formData.customerGroup" type="text" class="form-control"
            :placeholder="`Enter customerGroup`" />
        </div>

        <div class="mb-3">
          <label :for="startAt" class="form-label text-capitalize">startAt</label>
          <input :id="startAt" v-model="formData.startAt" type="datetime" class="form-control"
            :placeholder="`Enter startAt`" />
        </div>

        <div class="mb-3">
          <label :for="endAt" class="form-label text-capitalize">endAt</label>
          <input :id="endAt" v-model="formData.endAt" type="datetime" class="form-control"
