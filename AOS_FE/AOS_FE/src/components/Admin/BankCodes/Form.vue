  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      ...
      >
        ...
        <div class="mb-3">
          <label :for="bankCode" class="form-label text-capitalize">bankCode</label>
          <input
            :id="bankCode"
        ...
        <div class="mb-3">
          <label :for="bankName" class="form-label text-capitalize">bankName</label>
          <input
            :id="bankName"
        ...
        <div class="mb-3">
          <label :for="momoNumericCode" class="form-label text-capitalize">momoNumericCode</label>
          <input
            :id="momoNumericCode"
            v-model="formData.momoNumericCode"
            type="text"
            class="form-control"
            :placeholder="`Enter momoNumericCode`"
          />
        </div>
