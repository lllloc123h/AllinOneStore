  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          <label :for="keyMessage" class="form-label text-capitalize">keyMessage</label>
          <input :id="keyMessage" v-model="formData.keyMessage" type="text" class="form-control"
            :placeholder="`Enter keyMessage`" />
        </div>

        <div class="mb-3">
          <label :for="notification" class="form-label text-capitalize">notification</label>
          <input :id="notification" v-model="formData.notification" type="text" class="form-control"
