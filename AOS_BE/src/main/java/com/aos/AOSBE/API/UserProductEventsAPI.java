...
public class UserProductEventsAPI {
	...
	public ResponseEntity<?> getAllUserProductEventsApi(	
		...
		List<UserProductEventsDTOS> userProductEvents = pageResult.getContent().stream().map(userProductEventsMapper::mapper)
	...
	public ResponseEntity<UserProductEvents> getUserProductEventsByIdApi(@PathVariable int id) {
		...
		UserProductEvents userProductEvents =(UserProductEvents)userProductEventsService.userProductEventsFindById(id).orElse(new UserProductEvents());
	...
	public ResponseEntity<UserProductEvents> addNewUserProductEvents(@RequestBody UserProductEventsDTOS entity) {
	    ...
	    UserProductEvents saved = userProductEventsService.userProductEventsSave(userProductEventsMapper.mapperToObject(entity));	    
