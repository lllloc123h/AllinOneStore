...
import com.aos.AOSBE.DTOS.PurchaseOrdersDTOS;
import com.aos.AOSBE.Entity.PurchaseOrders;
import com.aos.AOSBE.Mapper.PurchaseOrdersMapper;
import com.aos.AOSBE.Service.PurchaseOrdersService;
...
public class PurchaseOrdersAPI {
	...
	public ResponseEntity<PurchaseOrders> getPurchaseOrdersByIdApi(@PathVariable int id) {
		...
		PurchaseOrders purchaseOrders = (PurchaseOrders) purchaseOrdersService.purchaseOrdersFindById(id)
				.orElse(new PurchaseOrders());
		return ResponseEntity.ok(purchaseOrders);
	}
